...
export function Rejected({ onClose, className }: RejectedProps) {
  return (
    <div className={cn("relative w-80 p-6 rounded-2xl bg-purple-200 text-center", className)}>
      ...
      <div className="flex justify-center mb-4">
        <div className="w-16 h-16 rounded-full border-2 border-purple-800 flex items-center justify-center">
          <X className="w-8 h-8 text-purple-800" />
        </div>
      </div>

      {/* Message */}
      <p className="text-purple-900 font-medium text-sm leading-relaxed">Campaign Rejected</p>
    </div>
  )
}
